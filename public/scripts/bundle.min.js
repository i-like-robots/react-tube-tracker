...
var React=require("react"),networkData=require("../common/data"),TubeTracker=require("../component/tube-tracker");window.app=function(){var e={"JSON decoding":window.JSON,"the selectors API":document.querySelector,"ES5 array methods":Array.prototype.forEach,"DOM level 2 events":window.addEventListener,"the HTML5 history API":window.history.pushState};for(var r in e)if(!e[r])return alert("Sorry, but your browser does not support "+r+" so this app won't work properly.");var t=JSON.parse(document.getElementById("initial-data").innerHTML);return React.renderComponent(TubeTracker({networkData:networkData,initialData:t}),document.body)}();
},{"../common/data":2,"../component/tube-tracker":6,"react":142}],2:[function(require,module,exports){
...
exports.debounceEvent=function(t,n){var r;return function(){clearTimeout(r),r=setTimeout(t,n)}},exports.httpRequest=function(t,n,r){var e=new XMLHttpRequest;e.open("GET",t),e.onload=function(){200===this.status?n(this.responseText):r(new Error(this.status))},e.onerror=function(){r(new Error(this.status))},e.send()},exports.apiRequestURL=function(t,n){return"/api/"+t+"/"+n},exports.formattedTimeUntil=function(t){var n=Math.round(t/60),r=30*Math.round((t-60*n)/30);return""+n+":"+(10>r?"0":"")+(r>0?r:"0")},exports.getQueryString=function(){return window.location.search},exports.formatQueryString=function(t){var n,r=[];for(n in t)t.hasOwnProperty(n)&&r.push(""+n+"="+t[n]);return"?"+r.join("&")},exports.queryStringProperty=function(t,n){var r=t.replace(/^\?/,"").replace(/\/$/,"").split("&"),e={};return r.forEach(function(t){t=t.split("="),e[t[0]]=t[1]}),e[n]},exports.isLine=function(t,n){return t in n.lines},exports.isStation=function(t,n){return t in n.stations},exports.isStationOnLine=function(t,n,r){return this.isLine(t,r)&&this.isStation(n,r)&&r.stationsOnLines[t].indexOf(n)>=0};
},{}],4:[function(require,module,exports){
(function (global){
var React=require("react"),utils=require("../common/utils"),Network=React.createClass({displayName:"Network",getInitialState:function(){return{collapsible:global?!1:window.innerWidth<=800,open:!1}},handleToggle:function(){this.setState({open:!this.state.open})},handleResize:function(){this.setState({collapsible:window.innerWidth<=800})},componentDidMount:function(){this.debounce=utils.debounceEvent(this.handleResize,250),window.addEventListener("resize",this.debounce,!1)},componentWillUnmount:function(){window.removeEventListener("resize",this.debounce,!1)},render:function(){var e=this.props.networkData,t=Object.keys(e.lines),n=this.state.open?"Close":"Open",i=this.state.collapsible?this.state.open?"is-open":"is-closed":"is-static",o=t.map(function(t,n){return Line({networkData:e,lineCode:t,key:n})},this);return React.DOM.div({className:"network "+i},o,React.DOM.button({type:"button",className:"network__toggle",onClick:this.handleToggle},n))}}),Line=React.createClass({displayName:"Line",handleSubmit:function(e){e.preventDefault();var t=new CustomEvent("tt:update",{detail:{station:this.refs.station.getDOMNode().value,line:this.props.lineCode},bubbles:!0});this.refs.form.getDOMNode().dispatchEvent(t)},render:function(){var e=this.props.lineCode,t=this.props.networkData,n=t.stationsOnLines[e],i=n.map(function(e,n){return React.DOM.option({value:e,key:n},t.stations[e])});return React.DOM.form({ref:"form",onSubmit:this.handleSubmit},React.DOM.fieldset({className:"network__line network__line--"+e},React.DOM.legend(null,t.lines[e]),React.DOM.input({type:"hidden",name:"line",value:e}),React.DOM.select({name:"station",ref:"station"},i),React.DOM.button({type:"submit",title:"View train times"},"Go")))}});module.exports=Network;
}).call(this,typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../common/utils":3,"react":142}],5:[function(require,module,exports){
var React=require("react"),utils=require("../common/utils"),Predictions=React.createClass({displayName:"Predictions",getInitialState:function(){return{status:this.props.initialData?"success":"welcome",predictionData:this.props.initialData}},fetchPredictions:function(t,e){this.setState({status:"loading"}),utils.httpRequest(utils.apiRequestURL(t,e),this.predictionsSuccess,this.predictionsError)},predictionsError:function(){this.setState({status:"error",predictionData:null})},predictionsSuccess:function(t){return t.length?void this.setState({status:"success",predictionData:JSON.parse(t)}):this.predictionsError(new Error("Invalid API response"))},resetPoll:function(t,e){this.fetchPredictions(t,e),this.poll&&clearInterval(this.poll),this.poll=setInterval(this.fetchPredictions.bind(this,t,e),3e4)},componentDidMount:function(){this.props.line&&this.props.station&&this.resetPoll(this.props.line,this.props.station)},componentWillUnmount:function(){clearInterval(this.poll)},componentWillReceiveProps:function(t){this.resetPoll(t.line,t.station)},shouldComponentUpdate:function(t,e){return this.props!==t||this.state.predictionData!==e.predictionData},render:function(){return"success"===this.state.status?DepartureBoard({ref:"content",predictionData:this.state.predictionData}):Notice({ref:"content",type:this.state.status})}}),DepartureBoard=React.createClass({displayName:"DepartureBoard",render:function(){var t=this.props.predictionData.station,e=this.props.predictionData.platforms,a=Object.keys(e).map(function(t,a){return React.DOM.div({className:"platform",key:"platform-"+a},React.DOM.h2({className:"platform__heading"},t),Trains({trains:e[t]}))});return React.DOM.div({className:"departures"},React.DOM.h1({className:"departures__heading"},t.stationName+" Station, "+t.lineName+" Line"),a)}}),Trains=React.createClass({displayName:"Trains",render:function(){var t=this.props.trains.map(function(t){var e=utils.formattedTimeUntil(t.timeToStation);return React.DOM.tr({className:"trains__arrival",key:"train-"+t.vehicleId},React.DOM.td(null,"0:00"===e?"-":e),React.DOM.td(null,t.towards),React.DOM.td(null,t.currentLocation))});return React.DOM.table({className:"trains"},React.DOM.thead(null,React.DOM.tr(null,React.DOM.th(null,"Time"),React.DOM.th(null,"Destination"),React.DOM.th(null,"Current location"))),React.DOM.tbody(null,t))}}),Notice=React.createClass({displayName:"Notice",statusText:function(t){var e;switch(t){case"error":e="Sorry an error occurred, please try again.";break;case"loading":e="Loading predictions…";break;case"welcome":e="Please choose a station."}return e},render:function(){return React.DOM.div({className:"notice notice--"+this.props.type},React.DOM.p(null,this.statusText(this.props.type)))}});module.exports=Predictions;
},{"../common/utils":3,"react":142}],6:[function(require,module,exports){
var React=require("react"),Predictions=require("./predictions"),Network=require("./network"),utils=require("../common/utils"),TubeTracker=React.createClass({displayName:"TubeTracker",formatAndValidateUserInput:function(t,e){var a=null,n=null;return utils.isStationOnLine(t,e,this.props.networkData)&&(a=t,n=e),{line:a,station:n}},getInitialState:function(){var t=this.props.initialData;return this.formatAndValidateUserInput(t?t.request.lineCode:null,t?t.request.stationCode:null)},handleUpdate:function(t){var e=this.formatAndValidateUserInput(t.detail.line,t.detail.station);e.line&&e.station&&this.setState(e)},componentWillUpdate:function(t,e){window.history.pushState(null,null,utils.formatQueryString(e))},componentDidMount:function(){window.addEventListener("tt:update",this.handleUpdate,!1)},componentWillUnmount:function(){window.removeEventListener("tt:update",this.handleUpdate,!1)},render:function(){return React.DOM.div({className:"layout"},React.DOM.div({className:"layout__sidebar"},Network({networkData:this.props.networkData})),React.DOM.div({className:"layout__content"},Predictions({line:this.state.line,station:this.state.station,networkData:this.props.networkData,initialData:this.props.initialData})))}});module.exports=TubeTracker;
},{"../common/utils":3,"./network":4,"./predictions":5,"react":142}],7:[function(require,module,exports){
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],16:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./DOMProperty":15,"./escapeTextForBrowser":105,"./memoizeStringOnly":127,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],17:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":27,"./createNodesFromMarkup":100,"./emptyFunction":103,"./getMarkupWrap":112,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],18:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":103,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventPluginRegistry":24,"./EventPluginUtils":25,"./ExecutionEnvironment":27,"./accumulate":94,"./forEachAccumulated":108,"./invariant":119,"./isEventSupported":120,"./monitorCodeUse":132,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],25:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":21,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],26:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":21,"./EventPluginHub":23,"./accumulate":94,"./forEachAccumulated":108,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],27:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactPropTypes":71,"./invariant":119,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],29:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],31:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactMount":62,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],33:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./PooledClass":30,"./invariant":119,"./traverseAllChildren":140,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactCurrentOwner":38,"./ReactOwner":66,"./ReactUpdates":78,"./invariant":119,"./keyMirror":125,"./merge":128,"./monitorCodeUse":132,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactDOMIDOperations":43,"./ReactMarkupChecksum":61,"./ReactMount":62,"./ReactPerf":67,"./ReactReconcileTransaction":73,"./getReactRootElementInContainer":114,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactComponent":34,"./ReactContext":37,"./ReactCurrentOwner":38,"./ReactErrorUtils":54,"./ReactOwner":66,"./ReactPerf":67,"./ReactPropTransferer":68,"./ReactPropTypeLocationNames":69,"./ReactPropTypeLocations":70,"./ReactUpdates":78,"./instantiateReactComponent":118,"./invariant":119,"./keyMirror":125,"./merge":128,"./mixInto":131,"./monitorCodeUse":132,"./objMap":133,"./shouldUpdateReactComponent":138,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],37:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":10,"./DOMProperty":15,"./DOMPropertyOperations":16,"./ReactBrowserComponentMixin":32,"./ReactComponent":34,"./ReactEventEmitter":55,"./ReactMount":62,"./ReactMultiChild":64,"./ReactPerf":67,"./escapeTextForBrowser":105,"./invariant":119,"./keyOf":126,"./merge":128,"./mixInto":131,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],42:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":10,"./DOMChildrenOperations":14,"./DOMPropertyOperations":16,"./ReactMount":62,"./ReactPerf":67,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],44:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactBrowserComponentMixin":32,"./ReactCompositeComponent":36,"./ReactDOM":39,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],47:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./AutoFocusMixin":8,"./LinkedValueUtils":28,"./ReactBrowserComponentMixin":32,"./ReactCompositeComponent":36,"./ReactDOM":39,"./invariant":119,"./merge":128,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],48:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":8,"./DOMPropertyOperations":16,"./LinkedValueUtils":28,"./ReactBrowserComponentMixin":32,"./ReactCompositeComponent":36,"./ReactDOM":39,"./invariant":119,"./merge":128,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],50:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":21,"./EventListener":22,"./EventPluginHub":23,"./EventPluginRegistry":24,"./ExecutionEnvironment":27,"./ReactEventEmitterMixin":56,"./ViewportMetrics":93,"./invariant":119,"./isEventSupported":120,"./merge":128,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],56:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactRootIndex":74,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],61:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./DOMProperty":15,"./ReactEventEmitter":55,"./ReactInstanceHandles":60,"./ReactPerf":67,"./containsNode":96,"./getReactRootElementInContainer":114,"./instantiateReactComponent":118,"./invariant":119,"./shouldUpdateReactComponent":138,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],63:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyObject":104,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],67:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],68:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./emptyFunction":103,"./invariant":119,"./joinClasses":124,"./merge":128,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],69:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],70:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":34,"./ReactPropTypeLocationNames":69,"./createObjectFrom":101,"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],72:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":34,"./ReactInstanceHandles":60,"./ReactMarkupChecksum":61,"./ReactServerRenderingTransaction":76,"./instantiateReactComponent":118,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],76:[function(require,module,exports){
/**
...
},{"./ReactPerf":67,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],79:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":21,"./EventPluginUtils":25,"./EventPropagators":26,"./SyntheticClipboardEvent":82,"./SyntheticDragEvent":84,"./SyntheticEvent":85,"./SyntheticFocusEvent":86,"./SyntheticKeyboardEvent":87,"./SyntheticMouseEvent":88,"./SyntheticTouchEvent":89,"./SyntheticUIEvent":90,"./SyntheticWheelEvent":91,"./invariant":119,"./keyOf":126,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],82:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],93:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],95:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],98:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactCompositeComponent":36,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],100:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":27,"./createArrayFrom":98,"./getMarkupWrap":112,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],101:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],102:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],105:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"./traverseAllChildren":140,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],107:[function(require,module,exports){
/**
 * Copyright 2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":27,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],113:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./warning":141,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],119:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],120:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],126:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"./keyMirror":125,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],130:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],133:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":34,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],136:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],139:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014 Facebook, Inc.
 *
...
},{"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],140:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactInstanceHandles":60,"./ReactTextComponent":77,"./invariant":119,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],141:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014 Facebook, Inc.
 *
...
},{"./emptyFunction":103,"/Users/matthinchliffe/Code/TubeTracker/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":7}],142:[function(require,module,exports){
