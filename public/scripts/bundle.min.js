...
var React=require("react"),networkData=require("../common/data"),TubeTracker=require("../component/tube-tracker");window.app=function(){var r={"the selectors API":document.querySelector,"ES5 array methods":Array.prototype.forEach,"DOM level 2 events":window.addEventListener,"the HTML5 history API":window.history.pushState};for(var e in r)if(!r[e])return alert("Sorry, but your browser does not support "+e+" so this app won't work properly.");return React.renderComponent(TubeTracker({networkData:networkData,initialData:null}),document.body)}();
